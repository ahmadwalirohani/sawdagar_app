...
class CommentsBloc extends ChangeNotifier {
  ...
  Future _getDate() async {
    ...
    String date = DateFormat('dd MMMM yy').format(now);
  ...
  Future reportComment(
    ...
    String? uid,
    String? commnetTimestamp,
  ) async {
    final SharedPreferences sp = await SharedPreferences.getInstance();
    final String? reporterUId = sp.getString('uid');
    final String documentName = 'comments_report';
    final String commentDocumentName = '$uid$commnetTimestamp';
