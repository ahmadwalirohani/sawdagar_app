...
class _IntroPageState extends State<IntroPage> {
  ...
  final List<Map<String, String>> pages = [
    {
      'title': 'intro-title1',
      'subtitle': 'intro-description1',
      'image': 'assets/images/slide1.png',
    },
    {
      'title': 'intro-title2',
      'subtitle': 'intro-description2',
      'image': 'assets/images/slide1.png',
    },
    {
      'title': 'intro-title3',
      'subtitle': 'intro-description3',
      'image': 'assets/images/slide1.png',
    },
  ];
      ...
      body: Container(
        decoration: const BoxDecoration(
          gradient: LinearGradient(
            colors: [
              Color.fromARGB(255, 255, 236, 183),
            ...
            children: [
                ...
                child: PageView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return Column(
                      ...
                      children: [
                        Image.asset(pages[index]['image']!, height: 450),
              ...
              SmoothPageIndicator(
                ...
                effect: ExpandingDotsEffect(
                  dotColor: const Color.fromARGB(145, 114, 114, 114),
                  activeDotColor: const Color.fromARGB(255, 36, 36, 36),
                  dotHeight: 10,
                  dotWidth: 10,
                ),
              ),
